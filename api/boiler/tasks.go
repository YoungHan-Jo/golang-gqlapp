...
type Task struct { // ユーザID
	ID []byte `boil:"id" json:"id" toml:"id" yaml:"id"`
	// ヒアリングID
	HearingID []byte `boil:"hearing_id" json:"hearing_id" toml:"hearing_id" yaml:"hearing_id"`
	// ヒアリング状況
	HearingStatus string `boil:"hearing_status" json:"hearing_status" toml:"hearing_status" yaml:"hearing_status"`
	// 業務名
...
var TaskTableColumns = struct {
	...
	ID:            "tasks.id",
	HearingID:     "tasks.hearing_id",
	HearingStatus: "tasks.hearing_status",
	Name:          "tasks.name",
	Staff:         "tasks.staff",
...
var TaskWhere = struct {
	...
	HearingStatus whereHelperstring
	...
	ID:            whereHelper__byte{field: "\"tasks\".\"id\""},
	HearingID:     whereHelper__byte{field: "\"tasks\".\"hearing_id\""},
	HearingStatus: whereHelperstring{field: "\"tasks\".\"hearing_status\""},
	Name:          whereHelpernull_String{field: "\"tasks\".\"name\""},
	Staff:         whereHelpernull_String{field: "\"tasks\".\"staff\""},
	Category:      whereHelpernull_String{field: "\"tasks\".\"category\""},
...
var TaskRels = struct {
	Hearing          string
	TaskEfficiencies string
	TaskMemos        string
	TaskProcesses    string
}{
	Hearing:          "Hearing",
	TaskEfficiencies: "TaskEfficiencies",
	TaskMemos:        "TaskMemos",
...
type taskR struct {
	...
	TaskEfficiencies TaskEfficiencySlice `boil:"TaskEfficiencies" json:"TaskEfficiencies" toml:"TaskEfficiencies" yaml:"TaskEfficiencies"`
	TaskMemos        TaskMemoSlice       `boil:"TaskMemos" json:"TaskMemos" toml:"TaskMemos" yaml:"TaskMemos"`
	TaskProcesses    TaskProcessSlice    `boil:"TaskProcesses" json:"TaskProcesses" toml:"TaskProcesses" yaml:"TaskProcesses"`
}
...
func (r *taskR) GetHearing() *Hearing {
	if r == nil {
		return nil
	}
	return r.Hearing
...
func (r *taskR) GetTaskEfficiencies() TaskEfficiencySlice {
	if r == nil {
		return nil
	}
	return r.TaskEfficiencies
}

func (r *taskR) GetTaskMemos() TaskMemoSlice {
	if r == nil {
		return nil
	}
	return r.TaskMemos
...
func (r *taskR) GetTaskProcesses() TaskProcessSlice {
	if r == nil {
		return nil
	}
	return r.TaskProcesses
}
...
var (
	taskAllColumns            = []string{"id", "hearing_id", "hearing_status", "name", "staff", "category", "created_at", "updated_at"}
	taskColumnsWithoutDefault = []string{"hearing_id", "hearing_status"}
	taskColumnsWithDefault    = []string{"id", "name", "staff", "category", "created_at", "updated_at"}
...
func (q taskQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Task, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boiler: failed to execute a one query for tasks")
	}
...
func (q taskQuery) All(ctx context.Context, exec boil.ContextExecutor) (TaskSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "boiler: failed to assign all query results to Task slice")
	}
...
func (q taskQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to count tasks rows")
	}
...
func (q taskQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "boiler: failed to check if tasks exists")
	}
...
func (o *Task) Hearing(mods ...qm.QueryMod) hearingQuery {
...
// TaskEfficiencies retrieves all the task_efficiency's TaskEfficiencies with an executor.
func (o *Task) TaskEfficiencies(mods ...qm.QueryMod) taskEfficiencyQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"task_efficiency\".\"task_id\"=?", o.ID),
	)

	return TaskEfficiencies(queryMods...)
}

// TaskMemos retrieves all the task_memo's TaskMemos with an executor.
func (o *Task) TaskMemos(mods ...qm.QueryMod) taskMemoQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"task_memos\".\"task_id\"=?", o.ID),
	)

	return TaskMemos(queryMods...)
}

// TaskProcesses retrieves all the task_process's TaskProcesses with an executor.
func (o *Task) TaskProcesses(mods ...qm.QueryMod) taskProcessQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"task_process\".\"task_id\"=?", o.ID),
	)

	return TaskProcesses(queryMods...)
}

// LoadHearing allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for an N-1 relationship.
func (taskL) LoadHearing(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTask interface{}, mods queries.Applicator) error {
	var slice []*Task
	var object *Task
...
// LoadTaskEfficiencies allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (taskL) LoadTaskEfficiencies(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTask interface{}, mods queries.Applicator) error {
	var slice []*Task
	var object *Task
	...
	query := NewQuery(
		qm.From(`task_efficiency`),
		qm.WhereIn(`task_efficiency.task_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	results, err := query.QueryContext(ctx, e)
	if err != nil {
		return errors.Wrap(err, "failed to eager load task_efficiency")
	}

	var resultSlice []*TaskEfficiency
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice task_efficiency")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on task_efficiency")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for task_efficiency")
	}
	...
	if singular {
		object.R.TaskEfficiencies = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &taskEfficiencyR{}
			}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if queries.Equal(local.ID, foreign.TaskID) {
				local.R.TaskEfficiencies = append(local.R.TaskEfficiencies, foreign)
				if foreign.R == nil {
					foreign.R = &taskEfficiencyR{}
				}
...
// LoadTaskMemos allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (taskL) LoadTaskMemos(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTask interface{}, mods queries.Applicator) error {
	var slice []*Task
	var object *Task
	...
	query := NewQuery(
		qm.From(`task_memos`),
		qm.WhereIn(`task_memos.task_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	results, err := query.QueryContext(ctx, e)
	if err != nil {
		return errors.Wrap(err, "failed to eager load task_memos")
	}

	var resultSlice []*TaskMemo
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice task_memos")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on task_memos")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for task_memos")
	}
	...
	if singular {
		object.R.TaskMemos = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &taskMemoR{}
			}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if queries.Equal(local.ID, foreign.TaskID) {
				local.R.TaskMemos = append(local.R.TaskMemos, foreign)
				if foreign.R == nil {
					foreign.R = &taskMemoR{}
				}
				foreign.R.Task = local
...
// LoadTaskProcesses allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (taskL) LoadTaskProcesses(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTask interface{}, mods queries.Applicator) error {
	var slice []*Task
	var object *Task
	...
	query := NewQuery(
		qm.From(`task_process`),
		qm.WhereIn(`task_process.task_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	results, err := query.QueryContext(ctx, e)
	if err != nil {
		return errors.Wrap(err, "failed to eager load task_process")
	}

	var resultSlice []*TaskProcess
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice task_process")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on task_process")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for task_process")
	}
	...
	if singular {
		object.R.TaskProcesses = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &taskProcessR{}
			}
			foreign.R.Task = object
		}
		return nil
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if queries.Equal(local.ID, foreign.TaskID) {
				local.R.TaskProcesses = append(local.R.TaskProcesses, foreign)
				if foreign.R == nil {
					foreign.R = &taskProcessR{}
				}
				foreign.R.Task = local
...
// SetHearing of the task to the related item.
// Sets o.R.Hearing to related.
// Adds o to related.R.Tasks.
func (o *Task) SetHearing(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Hearing) error {
	var err error
	if insert {
...
// AddTaskEfficiencies adds the given related objects to the existing relationships
// of the task, optionally inserting them as new records.
// Appends related to o.R.TaskEfficiencies.
// Sets related.R.Task appropriately.
func (o *Task) AddTaskEfficiencies(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*TaskEfficiency) error {
	var err error
	...
	if o.R == nil {
		o.R = &taskR{
			TaskEfficiencies: related,
		}
	} else {
		o.R.TaskEfficiencies = append(o.R.TaskEfficiencies, related...)
	}

	for _, rel := range related {
		if rel.R == nil {
			rel.R = &taskEfficiencyR{
				Task: o,
			}
		} else {
			rel.R.Task = o
...
// AddTaskMemos adds the given related objects to the existing relationships
// of the task, optionally inserting them as new records.
// Appends related to o.R.TaskMemos.
// Sets related.R.Task appropriately.
func (o *Task) AddTaskMemos(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*TaskMemo) error {
	var err error
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.TaskID, o.ID)
	...
	if o.R == nil {
		...
		o.R.TaskMemos = append(o.R.TaskMemos, related...)
	}
...
// AddTaskProcesses adds the given related objects to the existing relationships
// of the task, optionally inserting them as new records.
// Appends related to o.R.TaskProcesses.
// Sets related.R.Task appropriately.
func (o *Task) AddTaskProcesses(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*TaskProcess) error {
	var err error
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.TaskID, o.ID)
	...
	if o.R == nil {
		o.R = &taskR{
			TaskProcesses: related,
		}
	} else {
		o.R.TaskProcesses = append(o.R.TaskProcesses, related...)
	}
...
func FindTask(ctx context.Context, exec boil.ContextExecutor, iD []byte, selectCols ...string) (*Task, error) {
	taskObj := &Task{}
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boiler: unable to select from tasks")
	}
...
func (o *Task) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("boiler: no tasks provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to insert into tasks")
	}
...
func (o *Task) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("boiler: unable to update tasks, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update tasks row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by update for tasks")
	}
...
func (q taskQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update all for tasks")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to retrieve rows affected for tasks")
	}
...
func (o TaskSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update all in task slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to retrieve rows affected all in update all task")
	}
	return rowsAff, nil
}
...
func (o *Task) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("boiler: no tasks provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to upsert tasks")
	}
...
func (o *Task) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("boiler: no Task provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete from tasks")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by delete for tasks")
	}
...
func (q taskQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("boiler: no taskQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete all from tasks")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by deleteall for tasks")
	}
...
func (o TaskSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete all from task slice")
	}
...
func (o *TaskSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to reload all in TaskSlice")
	}
...
func TaskExists(ctx context.Context, exec boil.ContextExecutor, iD []byte) (bool, error) {
	var exists bool
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "boiler: unable to check if tasks exists")
	}
