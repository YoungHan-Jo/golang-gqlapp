...
type Company struct { // 会社ID
	...
	// アイコン画像URL
	IconImgURL null.String `boil:"icon_img_url" json:"icon_img_url,omitempty" toml:"icon_img_url" yaml:"icon_img_url,omitempty"`
	// データ作成日
...
var CompanyTableColumns = struct {
	...
	ID:                 "companies.id",
	Name:               "companies.name",
	RepresentativeName: "companies.representative_name",
	Status:             "companies.status",
	IconImgURL:         "companies.icon_img_url",
...
var CompanyWhere = struct {
	...
	IconImgURL         whereHelpernull_String
	CreatedAt          whereHelpertime_Time
	UpdatedAt          whereHelpertime_Time
}{
	ID:                 whereHelper__byte{field: "\"companies\".\"id\""},
	Name:               whereHelperstring{field: "\"companies\".\"name\""},
	RepresentativeName: whereHelperstring{field: "\"companies\".\"representative_name\""},
	Status:             whereHelperstring{field: "\"companies\".\"status\""},
	IconImgURL:         whereHelpernull_String{field: "\"companies\".\"icon_img_url\""},
...
var CompanyRels = struct {
	...
	HearingProjects: "HearingProjects",
	Users:           "Users",
}

// companyR is where relationships are stored.
type companyR struct {
	HearingProjects HearingProjectSlice `boil:"HearingProjects" json:"HearingProjects" toml:"HearingProjects" yaml:"HearingProjects"`
...
func (r *companyR) GetHearingProjects() HearingProjectSlice {
	if r == nil {
		return nil
	}
	return r.HearingProjects
}
...
var (
	companyAllColumns            = []string{"id", "name", "representative_name", "status", "icon_img_url", "created_at", "updated_at"}
	companyColumnsWithoutDefault = []string{"name", "representative_name", "status"}
	companyColumnsWithDefault    = []string{"id", "icon_img_url", "created_at", "updated_at"}
...
func (q companyQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Company, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boiler: failed to execute a one query for companies")
	}
...
func (q companyQuery) All(ctx context.Context, exec boil.ContextExecutor) (CompanySlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "boiler: failed to assign all query results to Company slice")
	}
...
func (q companyQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to count companies rows")
	}
...
func (q companyQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "boiler: failed to check if companies exists")
	}

	return count > 0, nil
}

// HearingProjects retrieves all the hearing_project's HearingProjects with an executor.
func (o *Company) HearingProjects(mods ...qm.QueryMod) hearingProjectQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"hearing_projects\".\"company_id\"=?", o.ID),
	)
...
// LoadHearingProjects allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (companyL) LoadHearingProjects(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCompany interface{}, mods queries.Applicator) error {
	var slice []*Company
	var object *Company
	...
	query := NewQuery(
		...
		qm.WhereIn(`hearing_projects.company_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err != nil {
		return errors.Wrap(err, "failed to eager load hearing_projects")
	}

	var resultSlice []*HearingProject
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice hearing_projects")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on hearing_projects")
	}
	...
	if singular {
		object.R.HearingProjects = resultSlice
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if queries.Equal(local.ID, foreign.CompanyID) {
				local.R.HearingProjects = append(local.R.HearingProjects, foreign)
				if foreign.R == nil {
					foreign.R = &hearingProjectR{}
				}
...
func (companyL) LoadUsers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCompany interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`users`),
		qm.WhereIn(`users.company_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// AddHearingProjects adds the given related objects to the existing relationships
// of the company, optionally inserting them as new records.
// Appends related to o.R.HearingProjects.
// Sets related.R.Company appropriately.
func (o *Company) AddHearingProjects(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*HearingProject) error {
	var err error
	...
	if o.R == nil {
		o.R = &companyR{
			HearingProjects: related,
		}
	} else {
		o.R.HearingProjects = append(o.R.HearingProjects, related...)
	}

	for _, rel := range related {
		if rel.R == nil {
			rel.R = &hearingProjectR{
				Company: o,
			}
		} else {
			rel.R.Company = o
...
func FindCompany(ctx context.Context, exec boil.ContextExecutor, iD []byte, selectCols ...string) (*Company, error) {
	companyObj := &Company{}
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boiler: unable to select from companies")
	}
...
func (o *Company) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("boiler: no companies provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to insert into companies")
	}
...
func (o *Company) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("boiler: unable to update companies, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update companies row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by update for companies")
	}
...
func (q companyQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update all for companies")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to retrieve rows affected for companies")
	}
...
func (o CompanySlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update all in company slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to retrieve rows affected all in update all company")
	}
	return rowsAff, nil
}
...
func (o *Company) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("boiler: no companies provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("boiler: unable to upsert companies, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to upsert companies")
	}
...
func (o *Company) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("boiler: no Company provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete from companies")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by delete for companies")
	}
...
func (q companyQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("boiler: no companyQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete all from companies")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by deleteall for companies")
	}
...
func (o CompanySlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete all from company slice")
	}
...
func (o *CompanySlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to reload all in CompanySlice")
	}
...
func CompanyExists(ctx context.Context, exec boil.ContextExecutor, iD []byte) (bool, error) {
	var exists bool
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "boiler: unable to check if companies exists")
	}
